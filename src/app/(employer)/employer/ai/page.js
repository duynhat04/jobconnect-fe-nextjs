  ...
  return (
    <div className="min-h-screen bg-gray-50 px-6 py-8">
      <div className="mx-auto max-w-6xl">
        {/* Header */}
        <div className="mb-8 overflow-hidden rounded-3xl bg-gradient-to-r from-emerald-500 via-green-500 to-teal-500 p-8 text-white shadow-lg">
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm leading-6 text-emerald-50 md:text-base">
                Hỗ trợ nhà tuyển dụng tư vấn tiêu chí tuyển dụng, kỹ năng cần có,
                cách viết tin tuyển dụng và đánh giá ứng viên phù hợp.
              </p>
            </div>
          ...
          <div className="lg:col-span-2">
            <div className="rounded-3xl border border-gray-100 bg-white p-6 shadow-sm">
              <div className="mb-5 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Nhập câu hỏi liên quan đến tuyển dụng, kỹ năng, JD hoặc đánh giá ứng viên.
                  </p>
                </div>
              </div>
              ...
              <textarea
                ...
                className="min-h-[190px] w-full resize-none rounded-2xl border border-gray-200 bg-gray-50 px-4 py-4 text-gray-800 outline-none transition focus:border-emerald-500 focus:bg-white focus:ring-4 focus:ring-emerald-50"
              />

              <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <p className="text-sm text-gray-500">
                  Gợi ý: hỏi ngắn gọn, rõ vị trí và kinh nghiệm mong muốn để AI trả lời chính xác hơn.
                </p>
                ...
                <button
                  ...
                  onClick={handleChat}
                  disabled={loading}
                  className="inline-flex items-center justify-center gap-2 rounded-xl bg-emerald-600 px-6 py-3 font-semibold text-white shadow-md shadow-emerald-100 transition hover:bg-emerald-700 disabled:cursor-not-allowed disabled:opacity-70"
                >
                  {loading ? (
                    <>
            ...
            <div className="mt-6">
              ...
              {!loading && result && (
                <div className="rounded-3xl border border-gray-100 bg-white p-6 shadow-sm">
                  <div className="mb-4 flex items-center justify-between gap-3 border-b border-gray-100 pb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          Bạn có thể sao chép nội dung này để sử dụng khi tuyển dụng.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="whitespace-pre-wrap rounded-2xl bg-gray-50 p-5 leading-7 text-gray-700">
                    {result}
                  </div>
                </div>
              )}
