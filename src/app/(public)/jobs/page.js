...
// IMPORT JOBCARD VÀO ĐÂY SẾP NHÉ
...
export default function JobListPage() {
  ...
  // Khởi tạo state bằng URL param truyền từ trang chủ sang (nếu có)
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 p-4 mt-6">
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
        <h1 className="text-2xl font-bold text-gray-800 mb-4">Tìm việc làm</h1>
      ...
      <div className="space-y-4">
        <h2 className="font-semibold text-gray-700">Tìm thấy {jobs.length} việc làm</h2>
        ...
        {loading ? (
          ...
          /* THAY VÌ VIẾT LẠI CODE DÀI DÒNG, GỌI JOBCARD RA ĐÂY */
